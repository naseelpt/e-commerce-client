...
<div className='rounded-4xl border bg-blue-400 w-96 py-12 gap-10'>
    <h1 className='text-3xl font-bold text-center text-white'>Login</h1>
                            ...
                            <div className='px-12  pt-5 '>
                               <Link to={"/register"}> <button className='w-72 h-10 rounded-4xl bg-blue-600 text-white'>login</button></Link>
                                <p>Don't have an acoount?<span style={{color:"blue"}}>register</span> here</p>
                            </div>
