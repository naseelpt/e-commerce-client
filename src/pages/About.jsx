...
function About() {
  ...
  <div className='cb '>
      ...
      <div className='grid md:grid-cols-2 pt-24'>
        <div className='pt-5'>
            <img src="https://style.me/wp-content/uploads/2022/01/styleme-fitting-room-bodaskins.png" alt="no image" />
        </div>

        <div className='pt-32'>
            <h1 className='text-2xl font-bold text-center'>Our Version</h1>
            <p className='px-16'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore architecto odit atque ut accusantium eligendi, doloremque, nemo fuga, modi quos unde possimus impedit voluptate magnam sit soluta. Ex, rem velit!</p>
        </div>
      </div>
      ...
      <div className='pt-32'>
        ...
        <div className='pt-5'>
            <img src="https://style.me/wp-content/uploads/2021/06/virtual-fitting-room-two-mobile-phones.png" alt="no image" />
        </div>
